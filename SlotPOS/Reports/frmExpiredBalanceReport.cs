...
{
    public partial class frmExpiredBalanceReport : Form
    {
        public frmExpiredBalanceReport()
        {
            InitializeComponent();
        }
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            ...
            SlotDataSetTableAdapters.Sp_ExpiredBalanceReportTableAdapter ad_mis = new SlotDataSetTableAdapters.Sp_ExpiredBalanceReportTableAdapter();
            ...
            using (StreamReader rdlcSR = new StreamReader(@"RdlcReport\rptExpiredBalanceReport.rdlc"))
            {
